...
alpha.sendMessage(from,  buttonMessagee, MessageType.buttonsMessage,{
        ...
        break
			...
			case 'mystatus':
				...
				teskny +=`\`\`\`Runtime : ${kyun(anu)}\`\`\``
				duingz = fs.readFileSync('./audio/d1.mp3')
				...
				alpha.sendMessage(from, duingz messageType.audio, {quoted: mek, mimetype: 'audio/mp4',ptt:true})
break
case 'getbio':
				if (!isGroup) return reply(lang.onlygc())
...
duingz = fs.readFileSync('./audio/d2.mp3')
alpha.sendMessage(from,  buttonMessagee, MessageType.buttonsMessage,{
alpha.sendMessage(from, duingz messageType.audio, {quoted: mek, mimetype: 'audio/mp4',ptt:true})
        caption: 'Botwea ©2k21',
        "contextInfo": {
